...
import type { AppSettings, ThemeConfig, ThemeMode } from '@shared/types'
...
export default function SettingsView({ settings, onChange }: Props): JSX.Element {
    ...
    <div className="view settings-page">
      ...
      <section className="panel">
        ...
        <p className="setting-desc">
          Prime Agent stores credentials in <code>~/.prime/agent/auth.json</code>. This app uses the same file.
        </p>
        <p className="setting-desc">
          Run <code>/login</code> in chat to store an API key, or open Prime Agent in Terminal for subscription OAuth.
        </p>
      </section>
      ...
      <section className="panel">
        ...
        <div className="setting-desc">
          ...
          <code>--mode rpc</code> protocol. Workers run with your user permissions — they are not a security sandbox.
        </div>
      </section>
    </div>
  )
